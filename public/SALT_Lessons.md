...
> [!NOTE]
>  **Result:** Net Na⁺ flux changes from positive (0.50) to negative (-0.33) due to a negative paracellular Na⁺ flux (-0.83). Net K⁺ flux also changes from positive (0.15) to negative (-0.77) due to a large negative paracellular K⁺ flux (-0.77). Osmotic pull changes from positive (0.3 toward blood) to negative (-0.5 toward lumen), and water secretion appears (-0.50 toward lumen). TEP is moderately lumen-positive (1.10).
...
> [!NOTE]
>  **Result:** Positive paracellular fluxes for Cl⁻ (0.64) and HCO₃⁻ (0.64). Net Na⁺ flux changes back to positive (0.50) and net K⁺ flux disappears, but there is a small positive basolateral flux (0.15). Osmotic pull increases (0.9 toward blood), but there is no water flux. TEP is smaller but still moderately lumen positive (0.79).
